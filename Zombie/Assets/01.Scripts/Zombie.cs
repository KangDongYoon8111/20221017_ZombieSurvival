...
public class Zombie : LivingEntity
{
    ...
    private void Awake()
    {
        ...
        zombieAudioPlayer = this.GetComponent<AudioSource>();
    ...
    private IEnumerator UpdatePath()
    {
        ...
        while (!dead)
        {
            ...
            else
            {
                ...
                // 20유닛의 반지름을 가진 가상의 구를 그렸을 때 구와
                // 겹치는 모든 콜라이더를 가져옴 단, whatIsTarget 레이어를
                // 가진 콜라이더만 가져오도록 필터링
                ...
                for(int i = 0;i < colliders.Length; i++)
                {
                    ...
                    // LivingEntitu 컴포넌트가 존재하며, 해당
                    // LivingEntity가 살아 있다면
    ...
    {
        // LivingEntity의 Die()를 실행하여 사망 처리 실행
        base.Die();
